...
import { Calendar, RefreshCw, Save, Star, ThumbsUp, ThumbsDown, Activity, Shirt, Eye, Gem, Watch, Brush, Sunglasses, Nail } from 'lucide-react';
...
const OutfitGenerator = () => {
  ...
  const stylingCategories = [
    ...
    { id: 'eyewear', name: 'Eyewear', icon: <Sunglasses className="h-4 w-4" /> },
    { id: 'nails', name: 'Nails', icon: <Nail className="h-4 w-4" /> }
  ];
